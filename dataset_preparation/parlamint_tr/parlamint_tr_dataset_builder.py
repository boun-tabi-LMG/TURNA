...
class Builder(tfds.core.GeneratorBasedBuilder):
    ...
    CORPUS_NAME = "parlaminttr"
    FILE_LIST_PARENT = True
    CORPUS_NAME = None  # To be defined in the subclasses
    FILE_LIST_PARENT = False  # Indicates whether the file list is located in the parent directory
