...
class Builder(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for yoktez dataset."""
  ...
  MANUAL_DOWNLOAD_INSTRUCTIONS = (
      "Put yoktez articles ('_no_inline_citations.txt') in the manual_dir / 'no_inline_txt' "
  )

  def _info(self) -> tfds.core.DatasetInfo:
    """Returns the dataset metadata."""
    # TODO(yoktez): Specifies the tfds.core.DatasetInfo object
  ...
  def _generate_examples(self, path, split):
    """Yields examples."""
    # TODO(yoktez): Yields (key, example) tuples from the dataset
